...
# Bouton du menu déroulant de selection
...
def main():
    global drag_drop_text, dropdown_button_text, selectsong_button_text
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if button_box.collidepoint(event.pos):
                    print("Fichier MP3 sélectionné:", selectsong_button_text)
                ...
                if selectsong_button_box.collidepoint(event.pos):
                    ...
                    selectsong_button_text = file_selector.parent.selectsong_button_text
